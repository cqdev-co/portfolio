# Unusual Options Signal Analysis - November 2025

**Analysis Date:** November 5, 2025  
**Data Range:** November 3-5, 2025  
**Total Signals:** 1,025  
**Total Premium Flow:** $1.9 Billion
...
- **Most Active:** AMD (180 signals), AAPL (102 signals), GOOG (73 signals)
...
- **AMD:** Split between calls and puts suggests volatility expectations
...
- **Interpretation:** Institutional battle zone - expect high volatility
...
- **Low IV:** 0.20-0.25 range = cheaper premium
- **Interpretation:** Consistent institutional accumulation
...
- **High conviction:** 0.90 scores despite OTM
- **Interpretation:** Bullish crypto positioning
- **Strategy:** Only play if Bitcoin bullish - high beta
...
1. **LVS $48 CALL exp 11/7** - $36.7M premium
   ...
   - Risk: Theta decay if no immediate catalyst

2. **DEO $75 CALL exp 01/16/26** - $19.8M premium
   - LEAPS with 70+ days
   - Deep ITM, low risk
   - Long-term value play on Diageo

3. **SPG $125 CALL exp 12/19** - $16.5M premium
   - Real estate recovery play
   - Deep ITM ($176 underlying)
   - 44 days to expiration

### Strategy 2: High Probability Near-Term Plays
...
- **Target:** $265+ by 11/14
- **Risk Level:** MEDIUM
- **Rationale:** Massive institutional interest, but contested

### Strategy 3: Volatility Plays (High IV)

For traders who want to capitalize on elevated volatility:

1. **BE $120 CALL exp 11/21**
   - IV: 1.52 | Premium: $1.18M
   - 18 total signals, $48.7M total flow
   - High volatility name with bullish bias

2. **CRCL $120 PUT exp 11/14**
   - IV: 1.25 | Premium: $1.9M
   - 19 signals with consistent bearish flow
   - Consider put spreads to reduce cost

3. **AXON $700 PUT exp 11/21**
   - IV: 0.79 | Premium: $7.9M
   - Stock at $641, protective positioning
   - Likely institutional hedging

### Strategy 4: Swing Trades (2-3 Week Horizon)

ITM/ATM options with Nov 21 expiration:

1. **DAVE $220 CALL exp 11/21**
   - Already ITM by $20 ($240 underlying)
   - $4.79M premium flow
   - Strong institutional conviction

2. **BMO $100 CALL exp 11/21**
   - Deep ITM ($124 underlying)
   - $6.53M premium
   - Banking sector play

3. **PKG $200 PUT exp 11/21**
   - ATM ($199 underlying)
   - $711K premium
   - Bearish setup on Packaging Corp

### Strategy 5: Speculative Plays (High Risk/Reward)

For smaller position sizing (<1% portfolio):

1. **RIO $72.5 CALL exp 01/16/26**
   - Underlying: $68.85 (5.3% OTM)
   - Long-dated LEAPS (70+ days)
   - Mining/commodity play with time value

2. **HUT $58 CALL exp 11/21**
   - Underlying: $49.96 (16% OTM)
   - Bitcoin mining correlation
   - High risk, watch BTC price action

3. **COIN $340 CALL exp 11/14**
   - Underlying: $318 (6.9% OTM)
   - 0.90 score despite distance
   - Only if bullish on crypto
...
- **Recommendation:** Only trade if confident in crypto direction
...
1. **Anything expiring 11/7 (Nov 7, 2025)**
   - Too little time remaining (<3 days)
   - Theta decay too high
   - Need immediate catalyst

2. **Deep ITM Puts (LII $640P, BKNG $6200P)**
   - Likely protective hedging
   - Not directional plays
   - Following could lead to losses

3. **Far OTM AMD Calls (>$285 strike)**
   - AMD at $258, needs >10% move
   - Contested name with mixed signals
   - Low probability

4. **Low IV Signals with Zero Premium Flow**
   - Some signals show $0 premium or zero IV
   - Data quality issues or market makers
   - Not reliable for trading decisions

---

## Trade Examples & P&L Scenarios
...
**Risk/Reward:** Good for bullish thesis, protected by intrinsic value
...
**Risk/Reward:** Strong setup with semiconductor momentum
...
## Advanced Strategy: Iron Condors on AMD
...
- **Credit Received:** ~$2.50 per spread
...
- **Avoid short-dated** (<7 days) unless very high conviction
...
- Understand that many signals may be hedges, not directional bets
