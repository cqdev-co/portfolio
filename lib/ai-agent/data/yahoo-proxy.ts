...
interface ProxyOptionsResult {
  ...
  options: Array<{
    ...
    calls: ProxyOptionContract[];
    puts: ProxyOptionContract[];
  }>;
}

interface ProxyOptionsResponse {
  optionChain?: {
    result?: ProxyOptionsResult[];
    error?: { code: string; description: string };
  };
}

interface ProxySummaryResult {
  price?: {
...
export async function fetchOptionsViaProxy(
  ticker: string,
  expirationDate?: number
): Promise<ProxyOptionsResult | null> {
  try {
...
export async function fetchSummaryViaProxy(
  ticker: string,
  modules?: string[]
): Promise<ProxySummaryResult | null> {
  try {
