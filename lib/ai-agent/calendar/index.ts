 ...
 *
 * Provides awareness of major market events for AI trading assistant.
 * Shared between CLI and Frontend for consistent calendar context.
 *
 * Events tracked:
 ...
 * @example
 * ```typescript
 * import { getCalendarContext, formatCalendarForAI } from '@lib/ai-agent';
 *
 * const ctx = getCalendarContext();
 * if (ctx.warnings.length > 0) {
 *   console.log('Calendar warnings:', ctx.warnings);
 * }
 * ```
 */
...
const FOMC_DATES = [
  ...
  { date: '2025-12-10', name: 'FOMC Meeting' },
  // 2026 (estimated based on typical schedule)
  { date: '2026-01-28', name: 'FOMC Meeting' },
  { date: '2026-03-18', name: 'FOMC Meeting' },
  { date: '2026-05-06', name: 'FOMC Meeting' },
  { date: '2026-06-17', name: 'FOMC Meeting' },
  { date: '2026-07-29', name: 'FOMC Meeting' },
  { date: '2026-09-16', name: 'FOMC Meeting' },
  { date: '2026-11-04', name: 'FOMC Meeting' },
  { date: '2026-12-16', name: 'FOMC Meeting' },
];
...
const WITCHING_DATES = [
  ...
  // 2026
  { date: '2026-03-20', name: 'Quad Witching' },
  { date: '2026-06-19', name: 'Quad Witching' },
  { date: '2026-09-18', name: 'Quad Witching' },
  { date: '2026-12-18', name: 'Quad Witching' },
];
...
const CPI_DATES = [
  ...
  // 2026
  { date: '2026-01-14', name: 'CPI Report' },
  { date: '2026-02-11', name: 'CPI Report' },
  { date: '2026-03-11', name: 'CPI Report' },
  { date: '2026-04-14', name: 'CPI Report' },
  { date: '2026-05-12', name: 'CPI Report' },
  { date: '2026-06-10', name: 'CPI Report' },
  { date: '2026-07-14', name: 'CPI Report' },
  { date: '2026-08-12', name: 'CPI Report' },
  { date: '2026-09-15', name: 'CPI Report' },
  { date: '2026-10-13', name: 'CPI Report' },
  { date: '2026-11-12', name: 'CPI Report' },
  { date: '2026-12-11', name: 'CPI Report' },
];

// Jobs Report / Non-Farm Payrolls (2024-2026)
...
const NFP_DATES = [
  ...
  // 2026
  { date: '2026-01-09', name: 'Jobs Report (NFP)' },
  { date: '2026-02-06', name: 'Jobs Report (NFP)' },
  { date: '2026-03-06', name: 'Jobs Report (NFP)' },
  { date: '2026-04-03', name: 'Jobs Report (NFP)' },
  { date: '2026-05-08', name: 'Jobs Report (NFP)' },
  { date: '2026-06-05', name: 'Jobs Report (NFP)' },
  { date: '2026-07-02', name: 'Jobs Report (NFP)' },
  { date: '2026-08-07', name: 'Jobs Report (NFP)' },
  { date: '2026-09-04', name: 'Jobs Report (NFP)' },
  { date: '2026-10-02', name: 'Jobs Report (NFP)' },
  { date: '2026-11-06', name: 'Jobs Report (NFP)' },
  { date: '2026-12-04', name: 'Jobs Report (NFP)' },
];

// GDP Releases (2024-2026)
...
const GDP_DATES = [
  ...
  // 2026
  { date: '2026-01-29', name: 'GDP Q4 Advance' },
  { date: '2026-02-26', name: 'GDP Q4 Second' },
  { date: '2026-03-26', name: 'GDP Q4 Third' },
  { date: '2026-04-29', name: 'GDP Q1 Advance' },
  { date: '2026-05-28', name: 'GDP Q1 Second' },
  { date: '2026-06-25', name: 'GDP Q1 Third' },
  { date: '2026-07-30', name: 'GDP Q2 Advance' },
  { date: '2026-08-27', name: 'GDP Q2 Second' },
  { date: '2026-09-24', name: 'GDP Q2 Third' },
  { date: '2026-10-29', name: 'GDP Q3 Advance' },
  { date: '2026-11-25', name: 'GDP Q3 Second' },
  { date: '2026-12-22', name: 'GDP Q3 Third' },
];

// Fed Beige Book (2024-2026)
const FED_EVENTS = [
  ...
  // 2026 Beige Book releases
  { date: '2026-01-14', name: 'Fed Beige Book' },
  { date: '2026-03-04', name: 'Fed Beige Book' },
  { date: '2026-04-22', name: 'Fed Beige Book' },
  { date: '2026-06-03', name: 'Fed Beige Book' },
  { date: '2026-07-15', name: 'Fed Beige Book' },
  { date: '2026-09-02', name: 'Fed Beige Book' },
...
function isHoliday(date: Date): boolean {
  ...
  return MARKET_HOLIDAYS.some((h) => h.date === dateStr);
}
...
export function getUpcomingEvents(withinDays: number = 14): MarketEvent[] {
  ...
  for (const witch of WITCHING_DATES) {
...
export function getCalendarContext(): CalendarContext {
  ...
  if (gdpSoon) {
    ...
    warnings.push(
      `📈 ${gdpSoon.name} ${formatDate(gdpSoon.date)} (${daysToGdp}d) - ` +
        `growth data release`
    );
  }
  ...
  if (witchingThisWeek) {
    warnings.push(
      `📊 Quad Witching ${formatDate(witchingThisWeek.date)} - ` +
        `expect high volume`
    );
  }
...
/**
 * Encode calendar context to TOON format for token efficiency
 */
export function encodeCalendarToTOON(): string {
  ...
  // Market status
  parts.push(`MKT:${ctx.marketStatus}`);

  // Next major event
  if (ctx.nextMajorEvent && ctx.daysUntilNextEvent) {
    parts.push(`NEXT:${ctx.nextMajorEvent.type}(${ctx.daysUntilNextEvent}d)`);
  }

  // Warnings count
  if (ctx.warnings.length > 0) {
    parts.push(`WARN:${ctx.warnings.length}`);
  }
