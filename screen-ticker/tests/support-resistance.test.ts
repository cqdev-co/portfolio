...
function createPatternedData(): HistoricalData[] {
  ...
  const prices = [
    105, 108, 110, 115, 118, 120, 119, 115, 110, 105, // down from 120
    100, 102, 105, 108, 112, 118, 120, 118, 115, 110, // bounce at 100
    105, 100, 103, 108, 115, 120, 117, 112, 108, 103, // another bounce
    100, 105, 110, 115, 118,                           // third bounce
  ];
...
describe("detectSupportResistance", () => {
  ...
  test("detects support levels at local minima", () => {
    ...
    const support100 = supports.find(
      l => l.price >= 98 && l.price <= 102
    );
  ...
  test("groups nearby levels within tolerance", () => {
    ...
    const prices = [
      105, 103, 100, 102, 105, 108, 110, // low at 100
      108, 105, 101, 103, 106, 109, 112, // low at 101
      110, 107, 99, 102, 105, 108, 110,  // low at 99
    ];
...
describe("isNearSupport", () => {
  ...
  test("respects custom threshold", () => {
    ...
    expect(isNearSupport(currentPrice, data, 0.10)).toBe(true);  // 10% - close
  });
});
