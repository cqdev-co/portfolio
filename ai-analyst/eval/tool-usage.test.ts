...
const POSITION_ANALYSIS_SCENARIOS: TestScenario[] = [
  ...
  },
  {
    ...
    userMessage:
      'My NVDA $185/$190 spread is currently worth $3.50. Should I hold?',
    expectedToolCalls: [
  ...
  },
  {
    ...
    userMessage:
      'Bought TSLA $420/$425 spread for $3.10 yesterday. What do you think?',
    expectedToolCalls: [
...
const TOOL_AVOIDANCE_SCENARIOS: TestScenario[] = [
  {
    ...
    expectedToolCalls: [{ toolName: 'get_ticker_data', shouldNotCall: true }],
    tags: ['efficiency'],
  },
  {
    id: 'avoid-002',
...
describe('Tool Usage - Aggregate Metrics', () => {
  test('All scenarios achieve minimum passing score', () => {
    ...
    console.log(
      `   Pass Rate: ${passCount}/${allScenarios.length} (${passRate.toFixed(0)}%)`
    );
