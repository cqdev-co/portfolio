...
/**
 * Next.js Error Boundary for the Unusual Options Scanner.
 * Catches runtime errors and displays a recovery UI
 * instead of crashing the entire page.
 */
export default function UnusualOptionsScannerError({
  error,
  reset,
}: {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 py-16 px-4">
      <div className="flex items-center gap-2 text-destructive">
        ...
        <h2 className="text-lg font-semibold">Unusual Options Scanner Error</h2>
      </div>
