...
import { HomeIcon, NotebookIcon, Activity, Palette } from 'lucide-react';
...
export const DATA = {
  ...
  about:
    'Specializing in secure application development, infrastructure hardening, and automations. Experienced in building resilient systems with Python, Docker, and Cloud technologies while implementing security by design principles.',
  ...
  navbar: [
    ...
    { href: '/wallpaper', icon: Palette, label: 'Wallpaper' },
  ],
  contact: {
  ...
  work: [
    {
      ...
      logoUrl: '/logos/cyera_symbol_dark.svg',
  ...
  education: [
    {
      ...
      href: 'https://du.edu',
      degree:
        'B.S. in Computer Science; Minor: Mathematics, Business Analytics',
