...
function getErrorDisplay(error: Error | undefined): {
  ...
  if (msg.includes("401") || msg.includes("unauthorized") || msg.includes("not authenticated") || msg.includes("not authorized")) {
  ...
  if (msg.includes("429") || msg.includes("rate") || msg.includes("limit")) {
    return {
      ...
      message: "You've reached the hourly usage limit. Please wait a few minutes or try a different model.",
      type: "rate_limit",
    };
  }
                    ...
                    <div className="flex items-start justify-between gap-2">
                      <div className="flex items-start gap-2">
                        ...
                        <div className="mt-0.5">
                          ...
                          {errorDisplay.type === "network" && (
                            <svg className="w-4 h-4" viewBox="0 0 16 16" fill="none">
                              <path d="M2 8a6 6 0 0112 0M4 8a4 4 0 018 0M6 8a2 2 0 014 0" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
                              <circle cx="8" cy="12" r="1" fill="currentColor"/>
                            </svg>
                          )}
                          {(errorDisplay.type === "server" || errorDisplay.type === "unknown") && (
                            <svg className="w-4 h-4" viewBox="0 0 16 16" fill="none">
