  ...
  return (
    ...
    >
      ...
      <div className="p-4">
          ...
          <div className="space-y-2">
            ...
            {adx && (
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium tabular-nums">{adx.toFixed(0)}</span>
              </div>
            )}
          ...
          <div className="space-y-2">
            ...
            {sectorContext?.vsAvg !== undefined && (
              <div className="flex items-center justify-between">
                ...
                <span className={cn(
                  "font-medium tabular-nums",
                  sectorContext.vsAvg > 20 ? "text-amber-500" :
                  sectorContext.vsAvg < -20 ? "text-emerald-600" :
                  "text-foreground"
                )}>
                  {sectorContext.vsAvg >= 0 ? "+" : ""}{sectorContext.vsAvg}%
                </span>
              </div>
            )}
          </div>
            ...
            {relativeStrength && (
              <div>
                ...
                <div className="flex items-center gap-2">
                  <span className={cn(
                    "font-medium tabular-nums",
                    relativeStrength.vsSPY > 0 ? "text-emerald-600" : 
                    relativeStrength.vsSPY < 0 ? "text-red-500" : 
                    "text-foreground"
                  )}>
        ...
        {(ma20 || ma50 || ma200) && (
          <div className={cn(
            ...
            <span className="text-[10px] font-medium text-muted-foreground 
                             uppercase tracking-wider">MAs</span>
            ...
            {targetPrices && (
              <div>
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className={cn(
                    "text-[11px]",
                    targetPrices.upside >= 0 ? "text-emerald-600" : "text-red-500"
                  )}>
                    {formatPct(targetPrices.upside)}
                  </span>
                </div>
                <div className="text-[10px] text-muted-foreground mt-0.5">
                  Range: ${targetPrices.low.toFixed(0)} – ${targetPrices.high.toFixed(0)}
                </div>
              </div>
            )}
            ...
            {analystRatings && (
              <div>
                ...
                <div className="flex items-center gap-2">
                  <div className={cn(
                    "font-semibold",
                    analystRatings.bullishPercent >= 70 ? "text-emerald-600" :
                    analystRatings.bullishPercent <= 30 ? "text-red-500" :
                    "text-foreground"
                  )}>
                ...
                <div className="text-[10px] text-muted-foreground mt-0.5">
                  {analystRatings.strongBuy}↑↑ {analystRatings.buy}↑ {analystRatings.hold}– {analystRatings.sell}↓
                </div>
              </div>
            )}
          </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center gap-3 mt-1">
                  <span>IV: <span className="font-medium">{iv.currentIV.toFixed(0)}%</span></span>
                  {iv.hv20 && (
                    <span>HV20: <span className="font-medium">{iv.hv20.toFixed(0)}%</span></span>
                  )}
                </div>
              </div>
              {iv.premium && (
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className={cn(
                  ...
                  ({pfv.divergence >= 0 ? "+" : ""}{pfv.divergence.toFixed(1)}%)
                </span>
              </div>
              <span className={cn(
        ...
        {earnings && (earnings.streak || earnings.lastSurprise !== undefined) && (
          <div className={cn(
            "mt-3 pt-3 border-t border-border/40",
            "text-xs"
          )}>
            ...
            <div className="flex items-center gap-4">
              {earnings.streak && (
                <div className="flex items-center gap-1.5">
                  ...
                  <span className={cn(
                    "font-medium",
                    earnings.streak > 0 ? "text-emerald-600" : "text-red-500"
                  )}>
                    {earnings.streak > 0 
              ...
              {earnings.lastSurprise !== undefined && (
                <div className="flex items-center gap-1.5">
                  ...
                  <span className={cn(
                    "font-medium tabular-nums",
                    earnings.lastSurprise >= 0 ? "text-emerald-600" : "text-red-500"
                  )}>
              ...
              {earnings.avgSurprise !== undefined && (
                <div className="flex items-center gap-1.5">
                  ...
                  <span className={cn(
                    "font-medium tabular-nums",
                    earnings.avgSurprise >= 0 ? "text-emerald-600" : "text-red-500"
                  )}>
            ...
            <div className="flex items-center gap-4">
              {performance.day5 !== undefined && (
                <div className="text-center">
                  <div className={cn(
                    "font-medium tabular-nums",
                    performance.day5 >= 0 ? "text-emerald-600" : "text-red-500"
                  )}>
              ...
              {performance.month1 !== undefined && (
                <div className="text-center">
                  <div className={cn(
                    "font-medium tabular-nums",
                    performance.month1 >= 0 ? "text-emerald-600" : "text-red-500"
                  )}>
        ...
        {grade && (
          <div className={cn(
            ...
            <span className={cn(
              ...
              grade.recommendation === "STRONG BUY" || grade.recommendation === "BUY"
